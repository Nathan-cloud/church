...
(function (h) {
	...
	function Ia(a) {
		...
		for (f = b.length; e < f; e++)
			if (((m = b[e]), (u = []), !m.sType && m._sManualType))
					...
					(j = m[i]),
						...
						j && j._bAttrSrc
							? (N(j.mData._)(d, l),
							  ...
							  u(j.mData.filter, a))
							: q
							? (j._setter || (j._setter = N(j.mData)), j._setter(d, l))
							: (d[i] = l);
				i++;
			};
		if (f)
	...
	function Ja(a, b, c, d) {
		...
		if (null === e.nTr) {
			...
			for (q = a.aoColumns.length; m < q; m++) {
				...
				if (
					k ||
					((!c || l.mRender || l.mData !== m) &&
						(!h.isPlainObject(l.mData) || l.mData._ !== m + '.display'))
				)
					i.innerHTML = B(a, b, m, 'display');
				l.sClass && (i.className += ' ' + l.sClass);
				l.bVisible && !c
					? j.appendChild(i)
					: !l.bVisible && c && i.parentNode.removeChild(i);
				l.fnCreatedCell &&
					l.fnCreatedCell.call(a.oInstance, i, B(a, b, m), f, b, m);
			}
			...
			if (0 !== i.length) {
				...
				for (j = j ? 0 : g; j < f; j++) {
					...
					if (0 !== e) {
						var G = d[c % e];
						q._sRowStripe != G &&
							(h(u).removeClass(q._sRowStripe).addClass(G),
							(q._sRowStripe = G));
					}
		...
		for (i = c.length; f < i; f++) {
			...
			for (e = d.firstChild; e; ) {
				if (
					...
					for (j = 0; j < m; j++)
						for (g = 0; g < q; g++)
							(a[f + g][l + j] = { cell: e, unique: k }), (a[f + g].nTr = d);
				}
				e = e.nextSibling;
			}
		}
	...
	function ta(a, b, c) {
		...
		a.fnServerData
			...
			: ((a.jqXHR = h.ajax(h.extend(l, g))), (g.data = f));
	}
	function nb(a) {
	...
	function wb(a) {
		...
		for (g = 0; g < c; g++)
			(l = b[g]),
				...
				u('mDataProp_' + g, i),
				d.bFilter &&
					(u('sSearch_' + g, m.sSearch),
					u('bRegex_' + g, m.bRegex),
					u('bSearchable_' + g, l.bSearchable)),
				d.bSort && u('bSortable_' + g, l.bSortable);
			...
			if (((h = a.aoData[d]), !h._aFilterData)) {
				...
				for (g = b.length; e < g; e++)
					(c = b[e]),
						...
						i.indexOf &&
							-1 !== i.indexOf('&') &&
							((wa.innerHTML = i), (i = Yb ? wa.textContent : wa.innerText)),
	...
	function ma(a) {
		...
		if (a.scrollBarVis !== L && a.scrollBarVis !== k)
			...
			s &&
				((R = s.clone().prependTo(p)), (Q = s.find('tr')), (R = R.find('tr')));
	...
	function Ha(a) {
		...
		for (n = 0; n < i.length; n++)
			(o = c[i[n]]),
				null !== o.sWidth && ((o.sWidth = Gb(o.sWidthOrig, k)), (u = !0));
		if (d || (!u && !f && !e && j == W(a) && j == l.length))
			...
			if (a.aoData.length)
				for (n = 0; n < i.length; n++)
					(u = i[n]),
						(o = c[u]),
						h(Hb(a, u)).clone(!1).append(o.sContentPadding).appendTo(r);
			...
			for (n = e = 0; n < i.length; n++)
				(k = h(l[n])),
					...
					(k = p.bBounding
						? Math.ceil(l[n].getBoundingClientRect().width)
						: k.outerWidth()),
					(e += k),
					(c[i[n]].sWidth = w(k - g));
			b.style.width = w(e);
	...
	function Y(a) {
		...
		for (a = 0; a < l.length; a++) {
			...
			for (c = f.length; b < c; b++)
				(g = f[b]),
					(j = e[g].sType || 'string'),
					l[a]._idx === k && (l[a]._idx = h.inArray(l[a][1], e[g].asSorting)),
					d.push({
						src: i,
						col: g,
						dir: l[a][1],
	...
	function Nb(a) {
		return function () {
			var b = [Aa(this[n.ext.iApiIndex])].concat(
			...
			this.each(function () {
				...
				if ('table' != this.nodeName.toLowerCase())
					...
					null === g.asStripeClasses &&
						(p.asStripeClasses = [s.sStripeOdd, s.sStripeEven]);
		...
		iterator: function (a, b, c, d) {
			...
			for (j = m.length; g < j; g++) {
				...
				if ('table' === b) (f = c.call(t, m[g], g)), f !== k && e.push(f);
					...
					(f = c.call(t, m[g], this[g], g)), f !== k && e.push(f);
				else if (
					'column' === b ||
					'column-rows' === b ||
					'row' === b ||
					...
					for (l = o.length; h < l; h++)
						(f = o[h]),
							(f =
								'cell' === b
									? c.call(t, m[g], f.row, f.column, g, h)
									: c.call(t, m[g], f, g, h, n)),
							f !== k && e.push(f);
				}
			}
			return e.length || d
	...
	o('tables()', function (a) {
		return a !== k && null !== a ? new r(Ub(a, this.context)) : this;
	});
	o('table()', function (a) {
		var a = this.tables(a),
			b = a.context;
	...
	var bb = function (a, b, c, d, e) {
			...
			for (l = b.length; i < l; i++) {
				...
				for (n = j.length; m < n; m++)
					(g = c('string' === typeof j[m] ? h.trim(j[m]) : j[m])) &&
						g.length &&
						(f = f.concat(g));
			}
			a = v.selector[a];
					...
					return bb(
						...
						function (a) {
							...
							if (a.nodeName) {
								...
								if (l)
									return i[l.row] && i[l.row].nTr === a.parentNode
										? [l.row]
										: [];
